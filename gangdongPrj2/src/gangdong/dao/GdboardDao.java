...
public class GdboardDao {
	...
	public int insert(Gdboard gdboard) throws Exception{
		...
		pstmt.setString(4, gdboard.getFilesrc());
	...
	public int update(Gdboard gdboard) throws Exception {
		String sql="update gdboard set gdtitle=?,gdcontent=?,"
				+ "filesrc=? where gdnum=?";
		...
		pstmt.setString(3, gdboard.getFilesrc());
		pstmt.setString(4, gdboard.getGdnum());
	...
	public Gdboard getGdboard(String gdnum) throws Exception {
		...
		g.setFilesrc(rs.getString("filesrc"));
